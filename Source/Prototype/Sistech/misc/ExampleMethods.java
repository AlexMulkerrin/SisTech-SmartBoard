...
public class MainPage {
    ...
    public static void main(String[] args) {
        ...
        {
            System.out.println(messages[i][0] + " : " + messages[i][1] + " : " + messages[i][2] + " : " + messages[i][3]);
        }
    }
...
class DayPane extends JPanel {
    ...
    public void addTask(int day, int month, int year) {
        ...
        for (int i=0; i<reminders.length; i++) {
            messageString= messageString + reminders[i][0] +"/n";
        }
    ...
    public DrawingPanel() {
        ...
        reply.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                sistech.MessageImage.saveMessage(DrawingPanel.this);
            }
        });
        this.add(reply);
